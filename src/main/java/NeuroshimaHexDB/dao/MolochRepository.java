...
public class MolochRepository extends SuperiorRepository<Moloch> {
    ...
    protected String insertSql() {
        return "INSERT INTO moloch (unit_name, initiative, primary_main_dmg, attributes) VALUES (?, ?, ?, ?)";
    }

    @Override
    protected String updateSql() {
        return "UPDATE moloch SET (unit_name, initiative, primary_main_dmg, attributes) = (?, ?, ?, ?) WHERE id = ?";
    }
    ...
    protected void setupInsert(Moloch moloch) throws SQLException {
        ...
        insert.setInt(3, moloch.getPrimary_main_damage());
        insert.setString(4, moloch.getAttributes());
    }
    ...
    protected void setUpdate(Moloch moloch) throws SQLException {
        ...
        update.setInt(3, moloch.getPrimary_main_damage());
        update.setString(4, moloch.getAttributes());
        update.setInt(5, moloch.getId());
    }
}
