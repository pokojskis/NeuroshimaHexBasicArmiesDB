...
public class PosterunekRepository extends SuperiorRepository<Posterunek> {
    ...
    protected String insertSql() {
        return "INSERT INTO posterunek (unit_name, initiative, attributes) VALUES (?, ?, ?)";
    }

    @Override
    protected String updateSql() {
        return "UPDATE posterunek SET (unit_name, initiative, attributes) = (?, ?, ?) WHERE id = ?";
    }
    ...
    protected void setupInsert(Posterunek posterunek) throws SQLException {
        ...
        insert.setString(3, posterunek.getAttributes());
    }
    ...
    protected void setUpdate(Posterunek posterunek) throws SQLException {
        ...
        update.setString(3, posterunek.getAttributes());
        update.setInt(4, posterunek.getId());
    }
}
